...
//This line uses the express.urlencoded middleware function to parse the request body as URL-encoded data. The extended option is set to true, which allows the use of nested objects and arrays.
